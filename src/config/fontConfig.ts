...
export const fontsList: FontDefinition[] = [
	...
	// ─── 本地字体示例 ───
	// 使用步骤：
	// 1. 将 TTF/OTF/WOFF2 字体文件放在 src/assets/fonts/ 目录下
	// 2. 参考下方配置填写正确的字体信息
	...
	{
		name: "ZhengGe DianHei 16",
		cssVariable: "--font-zhengge-dianhei-16",
		provider: "local",
		options: {
			variants: [
				{
					src: ["./src/assets/fonts/ZhengGeDianHei-16.ttf"],
				},
			],
		},
		fallbacks: ["sans-serif"],
...
export const fontConfig: FontSelectionConfig = {
	...
	selected: ["--font-zhengge-dianhei-16"],

	// 各区域独立字体设置（填写上方 fonts 中的 cssVariable，留空则使用全局 selected 字体）
	// 例如：bannerTitleFont: "--font-inter", 表示主页横幅主标题使用 Inter 字体
	// 主页横幅主标题字体
	bannerTitleFont: "--font-zhengge-dianhei-16",
	// 主页横幅副标题字体
	bannerSubtitleFont: "--font-zhengge-dianhei-16",
	// 导航栏标题字体
	navbarTitleFont: "",
	// 代码块字体（用于代码高亮和等宽字体场景）
